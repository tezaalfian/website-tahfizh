...
class Zakra_Customize_Typography_Control extends Zakra_Customize_Base_Control {
	...
	protected function content_template() {
		...
		<div class="zakra-typography-wrapper">
			...
			<div class="font-size">
				<h5><?php esc_html_e( 'Font size', 'zakra' ); ?></h5>
			...
			<div class="color">
				<h5><?php esc_attr_e( 'Color', 'zakra' ); ?></h5>
			...
			<div class="line-height">
				<h5><?php esc_attr_e( 'Line Height', 'zakra' ); ?></h5>
